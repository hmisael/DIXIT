...
import com.example.dixit_app.ui.rutinas.RutinaClickDeleteInterface
import com.example.dixit_app.ui.rutinas.RutinaClickInterface
import com.example.dixit_app.ui.rutinas.RutinasFragmentDirections
...
class PreguntasFragment :  Fragment(R.layout.fragment_preguntas),
    ...
    PreguntaClickInterface,
    PreguntaClickDeleteInterface {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val viewModelProviderFactory1 =
            PreguntaViewModelFactory(application, preguntaRepository)

        preguntaViewModel = ViewModelProvider(
            this, viewModelProviderFactory1)
    ...
    private fun setUpRecyclerView() {
        ...
        activity?.let {
            preguntaViewModel.getAllPreguntas().observe(
                viewLifecycleOwner, { preguntas ->
    ...
    private fun savePregunta(view: View, titulo: String) {
        if (titulo.isNotEmpty()) {
            ...
            lifecycleScope.launch {
                ...
                Snackbar.make(view, "Pregunta guardada exitosamente",
            ...
            activity?.toast("Por favor ingrese nombre de la Pregunta")
        }
    }
    ...
    private fun buscarPregunta(query: String?) {
        ...
        preguntaViewModel.searchPregunta(searchQuery).observe(
            this, { list ->
    ...
    override fun onDeletePreguntaClick(pregunta: Pregunta) {
        ...
        addDialog.setPositiveButton("Eliminar", DialogInterface.OnClickListener{
            ...
            //Informar al usuario
            Toast.makeText(context, "Pregunta ${pregunta.nombrePregunta} eliminada", Toast.LENGTH_LONG).show()
            dialog.dismiss()
        })
        addDialog.setNegativeButton("Cancelar", DialogInterface.OnClickListener{
                dialog, id ->
