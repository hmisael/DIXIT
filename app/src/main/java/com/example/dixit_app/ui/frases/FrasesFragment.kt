...
import com.example.dixit_app.ui.categorias.CategoriasFragmentDirections
...
class FrasesFragment : Fragment(R.layout.fragment_frases),
    ...
    private fun setUpRecyclerView() {
        ...
        activity?.let {
            fraseViewModel.getAllFrases().observe(
                viewLifecycleOwner, { frases ->
    ...
    private fun saveFrase(view: View, titulo: String) {
        if (titulo.isNotEmpty()) {
            ...
            lifecycleScope.launch {
                ...
                val direction =
                    FrasesFragmentDirections.actionFrasesFragmentToFraseDetalleFragment(fraseBD)
    ...
    override fun onFraseClick(frase: Frase) {
        ...
        val direction =
            FrasesFragmentDirections.actionFrasesFragmentToFraseDetalleFragment(frase)
        view?.findNavController()?.navigate(direction)
    ...
    override fun onDeleteFraseClick(frase: Frase) {
        ...
        addDialog.setPositiveButton("Eliminar", DialogInterface.OnClickListener{
            ...
            //Informar al usuario
            Toast.makeText(context, "Frase ${frase.nombreFrase} eliminada", Toast.LENGTH_LONG).show()
            dialog.dismiss()
        })
        addDialog.setNegativeButton("Cancelar", DialogInterface.OnClickListener{
                dialog, id ->
