...
class PictogramasFraseRVTopAdapter (val topAdapter : TopAdapterClickInterface) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PictogramaTopViewHolder {
        ...
        return PictogramaTopViewHolder(
            ItemPictogramaSelectedBinding.inflate(
    ...
    override fun onBindViewHolder(holder: PictogramaTopViewHolder, position: Int) {
        ...
        holder.itemBinding.nombrePictogramaSelected.text = pictogramaActual.nombrePictograma
        ...
        Glide.with(holder.itemView.context)
            .load(imageUri)
            .centerCrop()
            .into(holder.itemBinding.imageViewPictogramaSelected)
