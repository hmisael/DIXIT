...
class RutinasFragment : Fragment(R.layout.fragment_rutinas),
    ...
    private fun agregarRutina(){
        ...
        //setear vista
        val nombreRutina = v.findViewById<EditText>(R.id.et_categoria)
    ...
    private fun saveRutina(view: View, titulo: String) {
        ...
        if (titulo.isNotEmpty()) {
            ...
            //Pero en esta clase, luego de guardar, es necesario ir al Detalle de la Rutina

            val direction = RutinasFragmentDirections
                .actionRutinasFragmentToRutinaDetalleFragment(rutina)
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        menu.clear()
        inflater.inflate(R.menu.rutina_menu, menu)
