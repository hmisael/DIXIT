...
class RutinasFragment : Fragment(), SearchView.OnQueryTextListener,
                        RutinaClickInterface, RutinaClickDeleteInterface {
    ...
    private fun setUpRecyclerView() {
        ...
        activity?.let {
            rutinaViewModel.getAllRutinas().observe(viewLifecycleOwner) { rutinas ->
    ...
    private fun saveRutina(view: View, titulo: String) {
        if (titulo.isNotEmpty()) {
            ...
            Toast.makeText(context, "Por favor ingrese nombre de Rutina" , Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private fun buscarRutina(query: String?) {
        ...
        rutinaViewModel.searchRutina(searchQuery).observe(this) { list ->
    ...
    override fun onDeleteRutinaClick(rutina: Rutina) {
        ...
        addDialog.setPositiveButton("Eliminar", DialogInterface.OnClickListener{
                dialog, id ->
            //Se usa el método del ViewModel para eliminar la rutina seleccionada
