...
class PictogramaModificarFragment : Fragment() {

    private lateinit var binding: FragmentPictogramaModificarBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding = FragmentPictogramaModificarBinding.inflate(inflater, container,false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.fabDoneModPictograma.setOnClickListener{
            ...
            if (nombrePictograma.isNotEmpty()) {
                ...
                //TODO implementar funciones para eliminar imagen antigua y agregar una nueva
    ...
    private fun requestPermissionGaleria(view: View) {
        ...
        when {
            ...
            //Si shouldShowRequestPermissionRationale() es TRUE,
            // explicar al usuario por qué el necesario el permiso
    ...
    //TODO editar implementación like pictogramaNuevoFragment
